        ...
        <div
          ...
          <div
            ...
            <div
              ...
              {sizes?.length > 0 && (
                <div className="py-2">
                  <h3 className="text-center text-gray-700">Chọn size</h3>
                  {sizes.map(size => (
                    <label
                      key={size._id}
                      ...
                      <input
                        ...
                        name="size" />
                      {size.name} {basePrice + size.price}VND
                    </label>
                  ))}
                </div>
              )}
                ...
                <div className="py-2">
                  ...
                  {extraIngredientPrices.map(extraThing => (
                    <label
                      ...
                      {extraThing.name} +{extraThing.price}VND
                    </label>
                  ))}
                </div>
              )}
              <button
                ...
                <div className="primary sticky bottom-2"
                  ...
                  Thêm vào giỏ {selectedPrice}VND
                </div>
              </button>
              <button
                className="mt-2"
